...
typedef const struct orl_handle_struct *orl_handle;

struct orl_file_handle_struct;
typedef const struct orl_file_handle_struct *orl_file_handle;

struct orl_sec_handle_struct;
typedef const struct orl_sec_handle_struct *orl_sec_handle;

struct orl_symbol_handle_struct;
typedef const struct orl_symbol_handle_struct *orl_symbol_handle;

struct orl_group_handle_struct;
typedef const struct sorl_group_handle_struct *orl_group_handle;
...
typedef int32_t orl_sec_addend;
typedef uint32_t orl_sec_alignment;
typedef uint32_t orl_sec_frame;

typedef uint64_t orl_symbol_value;
typedef uint64_t orl_sec_base;

typedef uint32_t orl_table_index;

typedef uint32_t orl_rva;
...
typedef const struct sorl_linnum *orl_linnum;
